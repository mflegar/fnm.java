    ...
    if (selectedProject) {
      fetch(`/api/project/requestJoin`, {
        ...
        .then((data) => {
          ...
          setNotification({
            type: "success",
            message: "You've successfully submitted to join the project.",
          });
          localStorage.removeItem("institutionName");
      ...
      setNotification({
        type: "error",
        message: "Please select a project before submitting.",
      });
    }
  };
            ...
            {selectedProject && (
              <div className="text-sm">
                <p>
                  ...
                  {projects.find((p) => p.projectID === selectedProject)?.start}
                </p>
                <p>
                  <strong>State:</strong>{" "}
                  {projects.find((p) => p.projectID === selectedProject)?.state}
                </p>
              </div>
            )}
            {notification && (
