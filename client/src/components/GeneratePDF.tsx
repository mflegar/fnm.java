...
export const GeneratePDF = ({ expenses, institutionName, name }: GeneratePDFProps) => {
  const handleGeneratePDF = () => {
    ...
    const totalCost = expenses.reduce((sum, expense) => sum + expense.expense, 0);
  ...
  return (
    <div className="absolute bottom-6 right-6"> {/* Positioned button at the bottom right */}
